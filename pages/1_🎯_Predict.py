...
# Page configuration
st.set_page_config(page_title="Predict Risk Level", page_icon="🎯", layout="wide")
...
def create_feature_dataframe(form_inputs):
    """Convert form inputs to DataFrame with correct 43 features."""
    features = {}
    ...
    # Create DataFrame with exact column order (43 features)
...
st.markdown("Fill out the form below to predict student risk level.")
st.markdown("---")
